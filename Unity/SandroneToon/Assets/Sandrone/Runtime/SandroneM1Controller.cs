...
{
    public enum SandroneM1DebugMode
    {
        BaseLit = 0,
        NdotL = 1,
        NdotV = 2,
        HeadAxis = 3,
        MainLightColor = 4,
        MainLightDistanceAttenuation = 5
    }

    [ExecuteAlways]
    [DisallowMultipleComponent]
    public sealed class SandroneM1Controller : MonoBehaviour
    {
        [SerializeField] private Renderer targetRenderer;
        [SerializeField] private Transform characterRoot;
        [SerializeField] private Transform head;
        [SerializeField] private Light mainLight;
        [SerializeField] private SandroneM1DebugMode debugMode;
        ...
        private SandroneM1DebugMode cachedDebugMode = (SandroneM1DebugMode)(-1);

        private static readonly int DebugModeId = Shader.PropertyToID("_M1DebugMode");
        ...
        public SandroneM1DebugMode DebugMode
        {
            get => debugMode;
            set
            {
